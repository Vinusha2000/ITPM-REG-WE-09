  ...
  render() {
    return (
      <div className='bg-success p-2 text-dark bg-opacity-10'>
        ...
        <h1 className= "h3 mb-3 font-weight-normal">Update Payment Details</h1>
        ...
        <div className="form-group" style={{margineBottom:'15px'}}>
         <label style={{margineBottom:'5px'}}> Employee Type </label>
              ...
              onChange={this.handleInputChange}>
                ...
                <option defaultChecked>Select Employee Type</option>
...
<br></br>
  ...
  <button className="btn btn-primary" type="button" onClick={this.calculate}>Calculate Net Pay</button></div>
